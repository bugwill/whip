...
const sourcePath = resolve(projectRoot, 'assets/whip-logo.svg');
...
await sharp(sourcePath).resize(1024, 1024).png().toFile(foregroundImagePath);

writeFileSync(
  outputPath,
  `<?xml version="1.0" encoding="utf-8"?>
<!-- Generated from assets/whip-logo.svg. Do not edit by hand. -->
